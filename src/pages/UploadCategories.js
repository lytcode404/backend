...
const UploadCategories = () => {
  ...
  useEffect(() => {
    setUserData(uData);
    // console.log(uData?.AllCategories);
    if (uData?.AllCategories) {
      setFields(
        uData.AllCategories.map((category, index) => ({
          id: index + 1,
          value: category,
        }))
      );
      ...
      >
        <div className="text-center">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Are you sure you want to upload these Categories?
          </p>
